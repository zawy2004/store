            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    ...
                    <ul class="footer__list collapse show" id="demo2">
                        <li class="footer__item">
                            <a href="" class="footer__item--link">Cơ sở 1: Ngu Hanh Son ,Da Nang</a>
                        </li>
                        <li class="footer__item">
                            <a href="" class="footer__item--link">Cơ sở 2: Ngu Hanh Son ,Da Nang</a>
                        </li>
                        <li class="footer__item">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    ...
                    <ul class="footer__list collapse show" id="demo">
                        ...
                        <li class="footer__item">
                            <a href="./new.html" class="footer__item--link">Tin tức</a>
                        </li>
                        <li class="footer__item">
